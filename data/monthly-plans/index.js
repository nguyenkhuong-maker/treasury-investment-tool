window.MONTHLY_PLANS_TEST_DATA = {
  meta: {
    ...
    updatedAt: "2026-06-01T16:50:00+07:00",
    generatedBy: "Vesper",
  ...
  months: {
    "2026-06": {
      ...
      personal: {
        ...
        owner: "Finance Team",
        approver: "CFO",
        preparedAt: "01/06/2026 16:50 GMT+7",
        highlights: [
          ...
          { label: "Thanh khoản VPBank", value: "(0.206) tỷ VND" }
        ],
        contentHash: "sha256:test-personal-2026-06-draft3",
